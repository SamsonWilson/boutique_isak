...
from gestion_boutiques.boutiques.views.views_vente import VenteCreateView

from .views.views_stock import StockListView,StockCreateView,StockUpdateView,StockDeleteView
from .views.views_produit import DashboardView, ProduitDetailView,ProduitCreateView,ProduitUpdateView,ProduitDeleteView
