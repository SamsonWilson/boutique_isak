...
class ProduitListView(ListView):
    ...
    # Calcule la quantité nette pour chaque produit dans chaque boutique
        stock_summary = MouvementStock.objects.filter(
            boutique__isnull=False,  # <-- AJOUT : On ignore les stocks sans boutique
            produit__isnull=False    # <-- AJOUT : On ignore les stocks sans produit
        ).values(
            'boutique__id', 
            'boutique__nom', 
            'produit__id', 
            ...
            quantite_actuelle=Sum(
                Case(
                    ...
                    When(type_mouvement='sortie', then=-1 * F('quantite')),
                    default=0,
...
class DashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['stocks'] = (.venv) PS C:\Users\hugues\Desktop\Gestion_de_la_boutique> python manage.py makemigrations
C:\Users\hugues\AppData\Local\Programs\Python\Python311\python.exe: can't open file 'C:\\Users\\hugues\\Desktop\\Gestion_de_la_boutique\\manage.py': [Errno 2] No such file or directory
(.venv) PS C:\Users\hugues\Desktop\Gestion_de_la_boutique> python manage.py migrate
C:\Users\hugues\AppData\Local\Programs\Python\Python311\python.exe: can't open file 'C:\\Users\\hugues\\Desktop\\Gestion_de_la_boutique\\manage.py': [Errno 2] No such file or directory
(.venv) PS C:\Users\hugues\Desktop\Gestion_de_la_boutique> .objects.all()
