...
from .forms import VenteForm, ClientForm, DetailVenteFormSet # Assurez-vous d'importer vos formulaires

class VenteCreateView(LoginRequiredMixin, View):
    template_name = 'votre_template_de_vente.html' # Le template que vous avez montré
