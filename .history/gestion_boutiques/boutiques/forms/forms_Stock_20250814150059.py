...
class StockUpdateForm(forms.ModelForm):
    quantite_a_ajouter = forms.IntegerField(
        ...
        widget=forms.NumberInput(attrs={'id': 'id_quantite_a_ajouter','class': 'form-control', 'id':'id_quantite_a_ajouter', 'placeholder': 'Entrez la quantité à ajouter ou retirer'})
