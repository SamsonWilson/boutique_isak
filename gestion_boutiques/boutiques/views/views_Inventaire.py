...
class InventaireListView(ListView):
    ...
    def get_queryset(self):
        ...
        return Inventaire.objects.filter(boutique=self.boutique).order_by("-date_inventaire")
...
class InventaireDetailListeView(DetailView):
    model = Inventaire
    template_name = "inventaire/inventaire_detail_liste.html"
