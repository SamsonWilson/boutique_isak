...
class StockCourantListView(ListView):
    model = StockCourant
    template_name = "stocks/stock_courant_list.html"
...
class RapportStockView(View):
    template_name = "stocks/rapport_stock.html"
    def get(self, request):
        mouvements = MouvementStock.objects.all().order_by("date_mouvement")
        html = render_to_string("stocks/rapport_stock_pdf.html", {"mouvements": mouvements})
        response = HttpResponse(content_type="application/pdf")
        response['Content-Disposition'] = 'filename="rapport_stock.pdf"'
    ...
    #     mouvements = MouvementStock.objects.select_related("boutique", "produit", "utilisateur")

    #     # Filtres dynamiques
    #     if boutique_id:
    #         mouvements = mouvements.filter(boutique_id=boutique_id)
    #     if produit_id:
