...
from .views.views_pdf import VentePDFView

from .views.views_Inventaire import InventaireCreateView, InventaireDetailView, InventaireListView
...
# Inventaire
    ...
    path("inventaire/detail/<int:pk>/", InventaireDetailView.as_view(), name="inventaire_detail_list"),
