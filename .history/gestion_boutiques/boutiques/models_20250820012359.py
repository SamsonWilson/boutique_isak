...
class Produit(models.Model):
    ...
    prix_unitaire = models.DecimalField(max_digits=10, decimal_places=2)
        boutique = models.ForeignKey("Boutique", on_delete=models.CASCADE, related_name="produits")  # 👈 ajout
...
class StockCourant(models.Model):
    ...
    def __str__(self):
        return f"{self.produit} - {self.boutique} : {self.quantite}"
class MouvementStock(models.Model):
    ...
    def __str__(self):
        return f"{self.type_mouvement} {self.quantite} de {self.produit} ({self.boutique})"
        

class Client(models.Model):
    nom = models.CharField(max_length=100, default="xxxxxx", blank=True, null=True)
    contact = models.CharField(max_length=100, default="xxxxxx", blank=True, null=True)
    adresse = models.TextField(default="xxxxxx", blank=True, null=True)
...
class Inventaire(models.Model):
    ...
    description = models.TextField(default="xxxxxx",blank=True, null=True)
    utilisateur = models.ForeignKey(Utilisateur, on_delete=models.SET_NULL, null=True, blank=True)
