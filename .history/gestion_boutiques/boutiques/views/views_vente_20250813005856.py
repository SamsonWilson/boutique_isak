...
from django.shortcuts import render, redirect
from .forms import ClientForm, VenteForm, DetailVenteFormSet

def enregistrement_vente(request):
    if request.method == 'POST':
        ...
        if client_form.is_valid():
            ...
            vente_form = VenteForm(request.POST, initial={'client': client.id})
    ...
    return render(request, 'enregistrement_vente.html', {
