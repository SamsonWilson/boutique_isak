...
from .views.views_utilisateurs import AdminUserCreateView, ConnexionView, UtilisateurListView, UtilisateurUpdateView
...
# Utilisateurs
    ...
    path('users/<int:pk>/toggle-status/', views.ToggleUserStatusView.as_view(), name='user_toggle_status'),
]