...
from .views.views_stock import ProduitStockDetailView, StockCourantListView, StockDetailView, StockListView,StockCreateView,StockUpdateView,StockDeleteView
